...
var Createquery = "Create table if not exists user (user_id serial primary key, name varchar(50) not null, surname varchar(50), city varchar(500) not null,zip_code varchar(50) not null, phone_number varchar (50) unique not null)";
...
//creating the table
await using var reader = await cmd.Exe();
